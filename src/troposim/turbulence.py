...
def simulate(
    ...
    beta : float or Polynomial or ndarray[Polynomial]
        ...
        Polynomial: result from fit of radially averaged PSD vs frequency,
            in log-log scale
    ...
    >>> out = turbulence.simulate(shape=(3, 100, 100), beta=[2.0, 2.5, 3.0])
    """
